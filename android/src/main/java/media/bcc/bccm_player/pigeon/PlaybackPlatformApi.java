...
public class PlaybackPlatformApi {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class SubtitleCue {
    private @NonNull Long startTimeMs;

    public @NonNull Long getStartTimeMs() {
      return startTimeMs;
    }

    public void setStartTimeMs(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"startTimeMs\" is null.");
      }
      this.startTimeMs = setterArg;
    }

    private @NonNull Long endTimeMs;

    public @NonNull Long getEndTimeMs() {
      return endTimeMs;
    }

    public void setEndTimeMs(@NonNull Long setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"endTimeMs\" is null.");
      }
      this.endTimeMs = setterArg;
    }
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      SubtitleCue that = (SubtitleCue) o;
      return startTimeMs.equals(that.startTimeMs) && endTimeMs.equals(that.endTimeMs) && text.equals(that.text);
    }
    ...
    public static final class Builder {
      ...
      private @Nullable Long startTimeMs;

      @CanIgnoreReturnValue
      public @NonNull Builder setStartTimeMs(@NonNull Long setterArg) {
        this.startTimeMs = setterArg;
        return this;
      }

      private @Nullable Long endTimeMs;

      @CanIgnoreReturnValue
      public @NonNull Builder setEndTimeMs(@NonNull Long setterArg) {
        this.endTimeMs = setterArg;
        return this;
      }
      ...
      public @NonNull SubtitleCue build() {
        SubtitleCue pigeonReturn = new SubtitleCue();
        pigeonReturn.setStartTimeMs(startTimeMs);
        pigeonReturn.setEndTimeMs(endTimeMs);
    ...
    ArrayList<Object> toList() {
      ArrayList<Object> toListResult = new ArrayList<>(3);
      toListResult.add(startTimeMs);
      toListResult.add(endTimeMs);
      toListResult.add(text);
      return toListResult;
    }

    static @NonNull SubtitleCue fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      SubtitleCue pigeonResult = new SubtitleCue();
      Object startTimeMs = pigeonVar_list.get(0);
      pigeonResult.setStartTimeMs((Long) startTimeMs);
      Object endTimeMs = pigeonVar_list.get(1);
      pigeonResult.setEndTimeMs((Long) endTimeMs);
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class SubtitleEvent {
    private @NonNull String playerId;
    ...
    private @NonNull List<SubtitleCue> cues;

    public @NonNull List<SubtitleCue> getCues() {
      return cues;
    }

    public void setCues(@NonNull List<SubtitleCue> setterArg) {
      if (setterArg == null) {
        throw new IllegalStateException("Nonnull field \"cues\" is null.");
      }
      this.cues = setterArg;
    }
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      SubtitleEvent that = (SubtitleEvent) o;
      return playerId.equals(that.playerId) && language.equals(that.language) && cues.equals(that.cues);
    }

    @Override
    public int hashCode() {
      return Objects.hash(playerId, language, cues);
    }
    ...
    public static final class Builder {
      ...
      private @Nullable List<SubtitleCue> cues;

      @CanIgnoreReturnValue
      public @NonNull Builder setCues(@NonNull List<SubtitleCue> setterArg) {
        this.cues = setterArg;
        return this;
      }

      public @NonNull SubtitleEvent build() {
        SubtitleEvent pigeonReturn = new SubtitleEvent();
        pigeonReturn.setPlayerId(playerId);
        pigeonReturn.setLanguage(language);
        pigeonReturn.setCues(cues);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ...
      toListResult.add(playerId);
      toListResult.add(language);
      toListResult.add(cues);
      return toListResult;
    }

    static @NonNull SubtitleEvent fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      SubtitleEvent pigeonResult = new SubtitleEvent();
      Object playerId = pigeonVar_list.get(0);
      pigeonResult.setPlayerId((String) playerId);
      Object language = pigeonVar_list.get(1);
      pigeonResult.setLanguage((String) language);
      Object cues = pigeonVar_list.get(2);
      pigeonResult.setCues((List<SubtitleCue>) cues);
      return pigeonResult;
    }
  }
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 147:
          return SubtitleCue.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 148:
          return SubtitleEvent.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 149:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof SubtitleCue) {
        stream.write(147);
        writeValue(stream, ((SubtitleCue) value).toList());
      } else if (value instanceof SubtitleEvent) {
        stream.write(148);
        writeValue(stream, ((SubtitleEvent) value).toList());
  ...
  public static class PlaybackListenerPigeon {
    ...
    public void onCues(@NonNull SubtitleEvent eventArg, @NonNull VoidResult result) {
      final String channelName = "dev.flutter.pigeon.bccm_player.PlaybackListenerPigeon.onCues" + messageChannelSuffix;
      BasicMessageChannel<Object> channel =
          new BasicMessageChannel<>(
              binaryMessenger, channelName, getCodec());
      channel.send(
