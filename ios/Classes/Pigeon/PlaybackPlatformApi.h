...
@interface SubtitleEvent : NSObject
/// `init` unavailable to enforce nonnull fields, see the `make` class method.
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)makeWithPlayerId:(NSString *)playerId
...
@property(nonatomic, copy) NSArray<SubtitleCue *> * cues;
@end
...
- (void)onCues:(SubtitleEvent *)event completion:(void (^)(FlutterError *_Nullable))completion;
@end
