...
+ (SubtitleCue *)fromList:(NSArray<id> *)list;
+ (nullable SubtitleCue *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end

@interface SubtitleEvent ()
+ (SubtitleEvent *)fromList:(NSArray<id> *)list;
+ (nullable SubtitleEvent *)nullableFromList:(NSArray<id> *)list;
- (NSArray<id> *)toList;
@end
...
+ (instancetype)makeWithStartTimeMs:(NSInteger )startTimeMs
    endTimeMs:(NSInteger )endTimeMs
    text:(NSString *)text {
  SubtitleCue* pigeonResult = [[SubtitleCue alloc] init];
  pigeonResult.startTimeMs = startTimeMs;
  pigeonResult.endTimeMs = endTimeMs;
  pigeonResult.text = text;
  return pigeonResult;
}
+ (SubtitleCue *)fromList:(NSArray<id> *)list {
  SubtitleCue *pigeonResult = [[SubtitleCue alloc] init];
  pigeonResult.startTimeMs = [GetNullableObjectAtIndex(list, 0) integerValue];
  pigeonResult.endTimeMs = [GetNullableObjectAtIndex(list, 1) integerValue];
  pigeonResult.text = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable SubtitleCue *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [SubtitleCue fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    @(self.startTimeMs),
...
@implementation SubtitleEvent
+ (instancetype)makeWithPlayerId:(NSString *)playerId
    language:(NSString *)language
    cues:(NSArray<SubtitleCue *> *)cues {
  SubtitleEvent* pigeonResult = [[SubtitleEvent alloc] init];
  pigeonResult.playerId = playerId;
  pigeonResult.language = language;
  pigeonResult.cues = cues;
  return pigeonResult;
}
+ (SubtitleEvent *)fromList:(NSArray<id> *)list {
  SubtitleEvent *pigeonResult = [[SubtitleEvent alloc] init];
  ...
  pigeonResult.cues = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable SubtitleEvent *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [SubtitleEvent fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
    self.playerId ?: [NSNull null],
    self.language ?: [NSNull null],
    self.cues ?: [NSNull null],
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 147: 
      return [SubtitleCue fromList:[self readValue]];
    case 148: 
      return [SubtitleEvent fromList:[self readValue]];
    case 149: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[BufferModeBox class]]) {
    ...
    [self writeByte:146];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[SubtitleCue class]]) {
    [self writeByte:147];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[SubtitleEvent class]]) {
    [self writeByte:148];
    [self writeValue:[value toList]];
...
- (void)onCues:(SubtitleEvent *)arg_event completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.bccm_player.PlaybackListenerPigeon.onCues", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
